    ...
    private static readonly Lazy<FrozenDictionary<string, ComplianceMapping>> _all = new(() =>
        new Dictionary<string, ComplianceMapping>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["NA03"] = new()
            {
                CIS = "12.6",
                NIST = "3.1.16, 3.1.17",
                CMMC = "AC.L2-3.1.16, AC.L2-3.1.17",
                HIPAA = "164.312(e)(1)",
                PCI = "4.2.1, 11.2.1",
                SOC2 = "CC6.6",
                ISO27001 = "A.8.20",
                FedRAMP = "AC-18, AC-18(1)",
            },
            ["NA04"] = new()
            {
                CIS = "1.1, 1.2, 12.1",
            ...
            {
                CIS = "1.4, 12.5",
                NIST = "3.1.1, 3.1.2, 3.1.20",
                CMMC = "AC.L2-3.1.1, AC.L2-3.1.2, AC.L2-3.1.20",
                HIPAA = "164.312(a)(1)",
                PCI = "1.2.6, 2.2.7",
                SOC2 = "CC6.6",
                ISO27001 = "A.8.20",
                FedRAMP = "AC-3, AC-18, SC-7(7)",
            },
            ["NA06"] = new()
            {
                CIS = "4.4, 12.2, 12.7",
                NIST = "3.13.1, 3.13.5, 3.13.6",
                CMMC = "SC.L2-3.13.1, SC.L2-3.13.5, SC.L2-3.13.6",
                HIPAA = "164.312(e)(1)",
                PCI = "1.2.7, 2.2.6",
                SOC2 = "CC6.6, CC7.1",
                ISO27001 = "A.8.20, A.8.21",
                FedRAMP = "AC-17, SC-7, SC-7(4)",
            },
            ["NA07"] = new()
            {
                CIS = "1.4, 12.2, 12.5",
            ...
            {
                CIS = "3.6, 3.10",
                NIST = "3.8.1, 3.8.6, 3.13.11",
                CMMC = "MP.L2-3.8.1, MP.L2-3.8.6, SC.L2-3.13.11",
                HIPAA = "164.312(a)(2)(iv), 164.312(e)(2)(ii)",
                PCI = "3.5.1, 4.2.1",
                SOC2 = "CC6.7, A1.2",
            ...
            ["PS01"] = new()
            {
                ...
                HIPAA = "164.308(a)(1)(i), 164.308(a)(1)(ii)(A), 164.316(b)(1)",
                PCI = "12.1.1, 12.1.2",
            ...
            {
                CIS = "1.1",
                NIST = "3.1.1, 3.1.2, 3.2.1",
                CMMC = "AC.L2-3.1.1, AC.L2-3.1.2, AT.L2-3.2.1",
                HIPAA = "164.308(a)(5)(i), 164.316(b)(1)",
                PCI = "12.1.1",
                SOC2 = "CC1.1, CC1.2",
                ISO27001 = "A.5.1",
                FedRAMP = "AT-1, AT-2, PL-4",
            },
            ["PS03"] = new()
            {
                CIS = "17.1, 17.4",
                ...
                HIPAA = "164.308(a)(6)(i), 164.308(a)(6)(ii), 164.316(b)(1)",
                PCI = "12.10.1, 12.10.2",
                SOC2 = "CC7.3, CC7.4, CC7.5",
                ISO27001 = "A.5.24, A.5.25, A.5.26",
                FedRAMP = "IR-1, IR-4, IR-8",
            },
            ["PS04"] = new()
            {
                CIS = "5.2",
                NIST = "3.12.1",
                CMMC = "CA.L2-3.12.1",
                HIPAA = "164.308(a)(1)(ii)(D), 164.316(b)(2)(iii)",
                PCI = "12.4.1",
                SOC2 = "CC1.1, CC4.1, CC4.2",
                ISO27001 = "A.5.35, A.5.36",
                FedRAMP = "CA-2, CA-7, PM-10",
            },
            ["PS05"] = new()
            {
                CIS = "1.4, 12.5",
                ...
                FedRAMP = "RA-1, RA-3, RA-5",
            },
            ["PS06"] = new()
            {
                CIS = "14.1, 14.2",
                NIST = "3.2.1, 3.2.2, 3.2.3",
